...
class MusicPage(QWidget):
    def __init__(self, theme: Theme, parent: QWidget | None = None) -> None:
        ...
        self.lyric_line = ElideLabel("", mode=Qt.ElideRight)
        self.lyric_line.setObjectName("Subtle")
        self.lyric_line.setStyleSheet("font-size: 16px; font-style: italic;")
...
class SettingsPage(QWidget):
    ...
    def apply_settings(self, settings: Settings) -> None:
        ...
        self._sync_custom_actions(settings.custom_actions)
        self._rebuild_quick_actions_grid(settings.custom_actions)
